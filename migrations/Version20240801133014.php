 ...
 */
final class Version20240801133014 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE department department VARCHAR(255) DEFAULT NULL, CHANGE position position VARCHAR(255) DEFAULT NULL, CHANGE job job VARCHAR(150) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE department department VARCHAR(255) NOT NULL, CHANGE position position VARCHAR(255) NOT NULL, CHANGE job job VARCHAR(150) NOT NULL');
